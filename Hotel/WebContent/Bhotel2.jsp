...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i1.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i2.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i3.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i4.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i5.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i6.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i7.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B2i8.jpg" width="100%" alt="신라스테이"></div>
                    <div class="sw_txt">신라스테이 해운대</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="신라스테이 해운대"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/B2e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
휴양과 레저, 문화관광이 어우러진 글로벌 관광도시 해운대에 호텔신라의 프리미엄 비즈니스 호텔 브랜드, '신라스테이'를 선보입니다.
</p>
</div>
</div>
</div>
