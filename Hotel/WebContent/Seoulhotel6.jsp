...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/standard_double.jpg" width="100%" height="600px"alt="페이토"></div>
                    <div class="sw_txt">Standard Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/zenroom.jpg" width="100%"height="600px" alt="페이토"></div>
                    <div class="sw_txt">Zenroom</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/urban_double.jpg" width="100%"height="600px" alt="페이토"></div>
                    <div class="sw_txt">Urban Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/urban_twin.jpg" width="100%"height="600px" alt="페이토"></div>
                    <div class="sw_txt">Urban Twin room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/sweet1.jpg" width="100%"height="600px" alt="페이토"></div>
                    <div class="sw_txt">Sweet Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/outside2.jpg" width="100%" height="600px"alt="페이토"></div>
                    <div class="sw_txt">로비</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/outside4.jpg" width="100%"height="600px" alt="페이토"></div>
                    <div class="sw_txt">Restaurant</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel6/outside6.jpg" width="100%" height="600px"alt="페이토"></div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel5/standard_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/standard_double1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="payto"aria-label="Text input with checkbox" name="name">
</div>
...
<div class="input-group input-group-sm mb-3" style="width:70%;margin-top:20px;float:left;">
  ...
  <select class="custom-select mb-3" name="room">
      	...
      	<option name="room">ZenRoom</option>
      	<option name="room">Urban Double</option>
      	<option name="room">Urban Twin</option>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel6/zenroom.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/zenroom1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/bathroom.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<br/><hr/><br/>
<div>
<h3 class="big">Urban Room</h3>
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel6/urban_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item active">
      <img src="seoulhotel6/urban_double1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/bathroom2.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel6/urban_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item active">
      <img src="seoulhotel6/urban_twin1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/bathroom2.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel6/sweet1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/sweet.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/bathroom4.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel6/bathroom3.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<br/><hr/>
<div>
<img src="seoulhotel6/outside5.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>강남구에 있는 본 숙소(호텔 페이토 강남)는 본격적인 서울 여행 시작을 위한 이상적인 장소입니다. </p>
<p> 이 곳에서 생동감 넘치는 도시의 많은 것을 최대로 즐길 수 있습니다. </p><p>본 숙소는 도시의 필수 관광 명소에 쉽게 접근할 수 있는 편리한 위치를 자랑합니다.</p>
<br/>
<p>본 숙소(호텔 페이토 강남)의 시설과 서비스는 투숙객에게 즐거운 숙박 경험을 선사합니다.</p> 
<p>투 숙소는 매우 까다로운 투숙객도 만족시키는 다수의 숙소 내 시설을 제공합니다.</p><p>  본 숙소(호텔 페이토 강남)는 어떤 이유로 서울에 방문해도 지내기에 매우 좋은 곳입니다.</p>
</div>
</div>
</div>
<br/><hr/>
