...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i1.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
         <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i2.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i3.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i4.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i5.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i6.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i7.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B1i8.jpg" width="100%" alt="라마다앙코르"></div>
                    <div class="sw_txt">라마다 앙코르 바이 원덤 부산 해운대</div>
                </a>
            </div>
        </div>
...
<div style="width:330px;height:335px;margin-left:1300px;margin-right:50px;padding-top:15px;background-color:#d9dddc;border-radius:10px;">
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="라마다 앙코르 바이 원덤 부산 해운대"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/B1e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
라마다앙코르해운대는 세계 최다 호텔을 보유한 윈덤그룹(Wyndham)의 글로벌 브랜드 호텔로 10년의 호텔 설계 및 브랜드 도입 컨설팅 및 직영 호텔 운영으로 노하우를 갖춘 ㈜스타일로프트글로벌이 운영합니다. <br><br>

해운대역(부산 2호선)에서 바로 앞에 위치한 라마다앙코르해운대는 해운대의 해변과 도시를 모두 찾는 고객에게 가장 편안한 여행의 경험을 선사합니다. 
<br>해운대 해수욕장까지 도보 500m로 아름다운 바다를 가깝게 만날 수 있으며, 부산의 맛을 느낄 수 있는 다양한 먹거리도 쉽게 찾을 수 있습니다.<br>
 호텔에서 10분 거리에 위치한 벡스코는 대중교통으로도 이동할 수 있어 비즈니스로 해운대를 방문하시는 고객에게 교통의 편의까지 더하여 최고의 입지를 자랑합니다.
</p>
</div>
</div>
</div>
