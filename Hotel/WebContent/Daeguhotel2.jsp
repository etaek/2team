...
<title>Daegu February Hotel Dongseongro</title>
</head>
...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel2_out4.jpg"width="100%" alt="2월호텔 동성로스"></div>
                    <div class="sw_txt">2월호텔 동성로스</div>
                </a>
            </div>
         <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel2_in1.jpg" width="100%" alt="2월호텔 동성로스"></div>
                    <div class="sw_txt">2월호텔 동성로스</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel2_in2.jpg" width="100%" alt="2월호텔 동성로스"></div>
                    <div class="sw_txt">2월호텔 동성로스</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel2_in3.jpg" width="100%" alt="2월호텔 동성로스"></div>
                    <div class="sw_txt">2월호텔 동성로스</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel2_in6.jpg" width="100%" alt="2월호텔 동성로스"></div>
                    <div class="sw_txt">2월호텔 동성로스</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel2_in4.jpg" width="100%" alt="2월호텔 동성로스"></div>
                    <div class="sw_txt">2월호텔 동성로스</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel2_in1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel2_in2.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel2_in1.jpg" width="300px" height="300px"/>
    </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="2월호텔 동성로스"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel2_in5.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel2_in6.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel2_in7.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel2_in8.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel2_in7.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="daegu/daegu_hotel2_in3.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<br/><hr/>
<div>
<img src="daegu/daegu_hotel2_out2.jpg" style="margin-left:70px;width:90%;height:500px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
대구의 레스토랑, 쇼핑, 관광 지역에서 좋은 위치에 있는 본 숙소(호텔 2월 동성로)는 바쁜 일상으로부터 꿀맛 같은 휴식을 취할 수 있는 최적의 장소입니다. 본 2성급 숙소는 공항에서 단 6.95km 거리에 있어 쉽게 이동할 수 있습니다. 본 숙소는 도시의 필수 관광 명소에 손쉽게 접근할 수 있는 편리한 위치를 자랑합니다.

본 숙소(호텔 2월 동성로)는 최상의 서비스와 다양한 시설을 제공하며 고객의 편안한 투숙을 위해 최선의 노력을 다하고 있습니다. 투숙객 편의와 편안함을 위해 숙소에서 Wi-Fi (무료/전 객실), 24시간 경비 서비스, 편의점, 일일 청소 서비스, 24시간 프런트 데스크 등을 제공합니다.
</p>
</div>
</div>
</div>
