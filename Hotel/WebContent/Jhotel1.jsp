...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i1.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i2.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i3.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i4.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i5.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i6.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i7.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J1i8.jpg" width="100%" alt="호텔 휘슬락 제주"></div>
                    <div class="sw_txt">호텔 휘슬락 제주</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="호텔 휘슬락 제주"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/J1e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
달콤한 여행의 추억을 수집하고 싶은 당신에게 신비로운 제주의 바다가 한 폭의 그림으로 기억되는 곳, 호텔 휘슬락은 푸른 하늘을 유영하는 자유로운 종달새의 기운을 전하여, 이전에 당신이 경험해보지 못한 감동을 선사합니다. <br>
호텔 가득한 종달새의 노래 소리와 제주의 편백나무 향이 당신의 지루한 일상 속 잊혀진 ‘여행의 설렘’을 되찾아 줄 것입니다.
