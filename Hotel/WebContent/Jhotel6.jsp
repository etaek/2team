...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i1.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i2.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i3.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i4.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i5.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i6.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i7.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J6i8.jpg" width="100%" alt="호텔 더 본"></div>
                    <div class="sw_txt">호텔 더 본</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/J6i1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="image/J6i2.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="image/J6i3.jpg" width="300px" height="300px"/>
    </div>
    </div>
  </div>
</div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="호텔 더본"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="image/J6i4.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="image/J6i2.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div>
<img src="image/J6e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<h4>호텔 더본, 여러분의 맛있는 여행과 함께합니다.</h4>
<p>
합리적인 가격에 편안하고 아늑한 객실과 고품격 다이닝을 갖춘 호텔 더본이 제주의 휴양 문화를 한층 높은 격으로 이끌어 나아갑니다. <br>
호텔 더본은 지형과 물길에 순응하도록 설계되어, 정원이 자연으로 확장되는 구조를 통해 자연과 함께 호흡할 수 있는 공간입니다. <br>
객실에서 보는 자연과 어우러진 푸른 제주의 조망은 포근한 힐링을 드립니다.
