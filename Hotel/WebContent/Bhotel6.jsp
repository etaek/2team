...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i1.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i2.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i3.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i4.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i5.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i6.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i7.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B6i8.jpg" width="100%" alt="힐튼 부산"></div>
                    <div class="sw_txt">힐튼 부산</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="힐튼 부산"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/B6e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<h4>천혜의 자연 경관을 갖춘 힐튼 부산은 레저, 비즈니스 및 웨딩을 위한 완벽한 공간입니다.</h4>
<p>
부산의 아름다운 해변을 품은 기장에 위치한 힐튼 부산은 ‘도심 속 완벽한 휴식처’라는 차별화된 컨셉과 규모, 서비스를 선보입니다.<br>
탁 트인 오션뷰를 마음껏 감상 할 수 있는 약 18평의 넓고 여유로운 객실에는 프라이빗 발코니가 마련되어 휴식을 즐기기에 더 없이 좋은 시설을 자랑합니다.<br>
특히 해안경관이 파노라믹 뷰로 펼쳐지는 야외 인피니티 풀, 성인 전용 인피니티풀, 키즈 풀, 자쿠지 등 해외 리조트 못지 않은 럭셔리 수영장과 피트니스와 사우나, 테라피 룸 등의 부대시설들이 함께 마련되어 있어 사계절 내내 완벽한 휴식을 선사합니다.
</p>
</div>
</div>
</div>
