...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i1.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i2.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i3.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i4.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i5.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i6.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i7.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J5i8.jpg" width="100%" alt="탐라스테이 제주"></div>
                    <div class="sw_txt">탐라스테이호텔 제주</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="탐라스테이 호텔 제주"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/J5e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<h4>수줍게 고개 내민 일출의 풍광과 애월 해안가의 일몰을 품은 제주에서 마주한 가장 탐나는 탐라스테이 호텔입니다.</h4>
<p>
바다와 산, 그리고 숲이 어우러진 천혜의 휴양지 제주도 제주시에 위치한 저희 탐라스테이 호텔은 자연 속 힐링 느낌의 전문 휴양호텔로 제주 안에서의 작은 유럽을 만나보실 수 있습니다.<br>
고객의 즐거움과 행복한 추억을 위해 고객과의 인연을 소중히 여겨 함께 성장하고 발전하는 호텔이 될 수 있도록 최선을 다하며, 다양한 문화 컨텐츠를 제공함으로써<br>
제주도의 한류메카로 자리매김 할 수 있도록 더욱 더 노력하겠습니다. 더불어, 편안한 휴식공간이 될 수 있도록 전 직원 모두가 고객 한 분 , 한 분에게<br>
잊을 수 없는 최고의 서비스와 감동을 드릴 수 있도록 정성을 다하겠습니다.
</p>
</div>
</div>
</div>
