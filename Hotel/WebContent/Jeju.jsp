	...
	<div class="home__slider"> 
    	<div class="bxslider"> 
    		<figure class="snip1382">
  				<img src="hotel1.jpg" alt="sample99" height="300" width="400" />
  				<figcaption>
			...
			<figure class="snip1382">
  				<img src="hotel2.jpg" alt="sample99" height="300" width="400" />
  				<figcaption>
    				<h2>Gustav Purpleson</h2>
    				<p>Weekends don't count unless you spend them doing something completely pointless.</p>
    				<div class="icons"><a href="#"><i class="ion-chatbubbles"></i></a>
			...
			<figure class="snip1382">
  				<img src="hotel4.jpg" alt="sample99" height="300" width="400" />
  				<figcaption>
    				<h2>Gustav Purpleson</h2>
    				<p>Weekends don't count unless you spend them doing something completely pointless.</p>
    				<div class="icons"><a href="#"><i class="ion-chatbubbles"></i></a>
			...
			<figure class="snip1382">
  				<img src="hotel7.jpg" alt="sample99" height="300" width="400" />
  				<figcaption>
    				<h2>Gustav Purpleson</h2>
    				<p>Weekends don't count unless you spend them doing something completely pointless.</p>
    				<div class="icons"><a href="#"><i class="ion-chatbubbles"></i></a>
