...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/standard_double.jpg" width="100%" height="600px"alt="인터시티"></div>
                    <div class="sw_txt">Standard Double Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/standard_twin.jpg" width="100%"height="600px" alt="인터시티"></div>
                    <div class="sw_txt">Standard Twin Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/deluxe_double.jpg"width="100%"height="600px" alt="인터시티"></div>
                    <div class="sw_txt">Deluxe Double Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/family.jpg" width="100%"height="600px" alt="인터시티"></div>
                    <div class="sw_txt">Family Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/outside2.jpg" width="100%"height="600px" alt="인터시티"></div>
                    <div class="sw_txt">로비</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/outside3.jpg" width="100%" height="600px"alt="인터시티"></div>
                    <div class="sw_txt">연회장</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/outside4.jpg" width="100%"height="600px" alt="인터시티"></div>
                    <div class="sw_txt">Health Center</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel4/outside5.jpg" width="100%" height="600px"alt="인터시티"></div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel4/standard_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/standard_double1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/bathroom.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="intercity"aria-label="Text input with checkbox" name="name">
</div>
...
<div class="input-group input-group-sm mb-3" style="width:70%;margin-top:20px;float:left;">
  ...
  <select class="custom-select mb-3" name="room">
      	...
      	<option name="room">Family</option>
   		 </select>
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel4/standard_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/standard_twin1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel4/deluxe_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/bathroom.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/bathroom1.jpg" width="300px" height="300px"/>
    </div>
    </div>
  </div>
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel4/family.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/family1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel4/bathroom1.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div>
<img src="daejeonhotel4/outside1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>대전의 비즈니스, 레스토랑, 스파 지역에서 양질의 숙박을 제공하는 본 숙소(호텔 인터시티)는 비즈니스와 레저 여행객 모두에게 인기가 좋습니다.</p>
<p>본도심에서 단 3 km 거리에 있는 본 숙소는 투숙객이 빠르고 쉽게 지역의 많은 명소들을 즐길 수 있는 위치적 이점이 있습니다.</p>
<p>본 숙소는 유성온천, 홍인갤러리, 기신 서적 등과 같은 도시의 많은 명소로부터 매우 가까운 거리에 있어 편안한 휴식을 취할 수 있는 장소가 됩니다.</p>
<br/>
<p>본 숙소(호텔 인터시티)는 피곤하고 지친 여행자들을 기운 나게 하기 위한 우수한 서비스와 모든 필수 시설을 제공합니다.</p> 
<p>투숙객 편의와 편안함을 위해 숙소에서 24시간 룸서비스, Wi-Fi (무료/전 객실), 24시간 프런트 데스크, 장애인용 편의시설, 익스프레스 체크인/체크아웃 등을 제공합니다.</p>
</div>
</div>
</div>
<br/><hr/>
