...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel3_out2.jpg"width="100%" alt="아호텔인섬니아"></div>
                    <div class="sw_txt">아호텔인섬니아</div>
                </a>
            </div>
         <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel3_in1.jpg" width="100%" alt="아호텔인섬니아"></div>
                    <div class="sw_txt">아호텔인섬니아</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel3_in2.jpg" width="100%" alt="아호텔인섬니아"></div>
                    <div class="sw_txt">아호텔인섬니아</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel3_in3.jpg" width="100%" alt="아호텔인섬니아"></div>
                    <div class="sw_txt">아호텔인섬니아</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel3_in5.jpg" width="100%" alt="아호텔인섬니아"></div>
                    <div class="sw_txt">아호텔인섬니아</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel3_in8.jpg" width="100%" alt="아호텔인섬니아"></div>
                    <div class="sw_txt">아호텔인섬니아</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel3_in1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel3_in2.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel3_in1.jpg" width="300px" height="300px"/>
    </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="아호텔인섬니아"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel3_in5.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel3_in6.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel3_in7.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel3_in8.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel3_in7.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="daegu/daegu_hotel3_in3.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<br/><hr/>
<div>
<img src="daegu/daegu_hotel3_out2.jpg" style="margin-left:70px;width:90%;height:500px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
대구에 위치한 호텔 인섬니아는 무료 Wi-Fi와 에어컨이 완비된 객실을 제공합니다. 호텔에는 24시간 프런트 데스크와 테라스가 있습니다. 이 금연 호텔은 김광석 거리에서 1.7km 내에 있습니다.

호텔에서 매일 미국식 조식을 즐겨보십시오.

호텔 인섬니아는 두류공원에서 6km, 대구 삼성 라이온즈 파크에서 9km 떨어져 있습니다.

커플들이 선호하는 지역 — 커플 투숙에 평점 9.0점을 획득하였습니다.
</p>
</div>
</div>
</div>
