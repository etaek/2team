...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i1.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i2.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i3.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i4.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i5.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i6.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i7.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J4i8.jpg" width="100%" alt="씨에스 호텔 앤 리조트"></div>
                    <div class="sw_txt">씨에스 호텔 앤 리조트</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="씨에스 호텔 앤 리조트"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/J4e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<h4>"전통과 현대의 조화, 자연과 모던의 만남"</h4>
<p>
아름다운 제주 중문단지에 위치한 씨에스호텔앤리조트는 1만3천여 평의 부지에 현대와 전통이 어우러진, 자연과 공존하는 단독 별장형 객실을 제공하여 고객님께 최고의 휴식과 아름다운 추억을 제공합니다. <br><br>
바다가 보이는 전통한실을 비롯한 총 7개 타입의 품위 있는 객실, 제주돌담, 초가, 아름다운 정원과 분수연못, 노천탕, 바다가 친구인 알드르 잔디광장이 고객님을 맞이하고 있으며, 인기드라마 시크릿가든, 미안하다 사랑한다, 꽃보다남자, 궁 등의 드라마 촬영장소로도 유명하여 제주 여행시에 꼭 들르고 싶은 관광명소입니다.<br><br>
신선한 재료와 정성이 깃든 제주 전통음식, 일식, 한정식 등 고객에게 최상의 서비스를 제공하여 제주 국제 컨벤션센터와 더불어 각국 외교사절단 문화교류의 장으로 활용되고, 각종 세미나와 연회 등의 명소로 각광받고 있습니다
</p>
</div>
</div>
</div>
