...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/standard_double.jpg" width="100%" height="600px"alt="신라"></div>
                    <div class="sw_txt">Standard Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/standard_twin.jpg" width="100%"height="600px" alt="신라"></div>
                    <div class="sw_txt">Standard Twin room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/deluxe_double.jpg" width="100%"height="600px" alt="신라"></div>
                    <div class="sw_txt">Deluxe Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/deluxe_twin.jpg" width="100%"height="600px" alt="신라"></div>
                    <div class="sw_txt">Deluxe Twin room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/family twin.jpg" width="100%"height="600px" alt="신라"></div>
                    <div class="sw_txt">Family Twin</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/outside2.jpg" width="100%" height="600px"alt="신라"></div>
                    <div class="sw_txt">로비</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/outside4.jpg" width="100%"height="600px" alt="신라"></div>
                    <div class="sw_txt">Restaurant</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel5/outside7.jpg" width="100%" height="600px"alt="신라"></div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="sinla"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel5/standard_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/standard_twin1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel5/deluxe_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel5/deluxe_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel5/family twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/family_twin1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div>
<img src="seoulhotel5/outside1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>명동 중심에 위치한 본 숙소(신라스테이 서대문)는 서울 여행을 위한 최적의 장소입니다. </p>
<p> 본 4성급 숙소는 공항에서 단 24km 거리에 있어 쉽게 이동할 수 있습니다. </p><p>본 숙소는 도시의 필수 관광 명소에 쉽게 접근할 수 있는 편리한 위치를 자랑합니다.</p>
<br/>
<p>본 숙소(신라스테이 서대문)는 최상의 서비스와 다양한 시설을 제공하며 고객의 편안한 투숙을 위해 최선의 노력을 다하고 있습니다.</p> 
<p>투숙객 편의와 편안함을 위해 숙소에서 Wi-Fi (무료/전 객실), 24시간 프런트 데스크, 장애인용 편의시설, 여행 가방 보관, Wi-Fi (공공 장소) 등을 제공합니다.</p>
</div>
</div>
</div>
<br/><hr/>
