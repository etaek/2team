...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/standard_double.jpg" width="100%" height="600px"alt="토요코"></div>
                    <div class="sw_txt">Standard Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/standard_twin.jpg" width="100%"height="600px" alt="토요코"></div>
                    <div class="sw_txt">Standard Twin Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/deluxe_double.jpg" width="100%"height="600px" alt="토요코"></div>
                    <div class="sw_txt">Deluxe Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/deluxe_twin.jpg" width="100%"height="600px" alt="토요코"></div>
                    <div class="sw_txt">Deluxe Twin room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/sweet.jpg" width="100%"height="600px" alt="토요코"></div>
                    <div class="sw_txt">Sweet Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/outside2.jpg" width="100%" height="600px"alt="토요코"></div>
                    <div class="sw_txt">공용공간</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/outside3.jpg" width="100%"height="600px" alt="토요코"></div>
                    <div class="sw_txt">Restaurant</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel5/outside1.jpg" width="100%" height="600px"alt="토요코"></div>
                    <div class="sw_txt">건물 외관</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel5/standard_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/standard_double1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
...
<div class="input-group mb-3" style=" width:100% ">
  ...
  <input type="text" class="form-control" value="Toyoko In"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel5/standard_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/standard_twin1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/><br/>
<div>
<h3 class="big">Deluxe Double Room</h3>
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel5/deluxe_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item active">
      <img src="daejeonhotel5/deluxe_double1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel5/deluxe_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item active">
      <img src="daejeonhotel5/deluxe_twin1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel5/sweet.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/sweet1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel5/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div style="">
<img src="daejeonhotel5/outside1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>대전의 편리한 위치에 있는 토요코 인 대전정부청사앞에서 여행을 시작해 보세요.</p>
<p>이 곳에서 생동감 넘치는 도시의 많은 것을 최대로 즐길 수 있습니다.</p><p>본 숙소는 도시의 필수 관광 명소에 손쉽게 접근할 수 있는 편리한 위치를 자랑합니다.</p>
<br/>
<p>최고의 서비스와 시설로 잘 알려진 Toyoko Inn의 토요코 인 대전정부청사앞에서 특별한 경험이 고객들을 기다립니다.</p> 
<p>Wi-Fi (무료/전 객실), 세탁실, 24시간 프런트 데스크, Wi-Fi (공공 장소), 신문 등과 같은 최상급 편의/부대 시설을 본 숙소에서 즐길 수 있습니다.</p><p>토요코 인 대전정부청사앞의 전문적인 서비스와 다양한 특색의 매력적인 조합을 발견해 보세요.</p>
</div>
</div>
</div>
<br/><hr/>
