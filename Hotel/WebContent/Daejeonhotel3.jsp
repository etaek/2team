...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/standard_double.jpg" width="100%" height="600px"alt="레지던스"></div>
                    <div class="sw_txt">Standard Double Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/standard_twin.jpg" width="100%"height="600px" alt="레지던스"></div>
                    <div class="sw_txt">Standard Twin Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/deluxe_twin.jpg"width="100%"height="600px" alt="레지던스"></div>
                    <div class="sw_txt">Deluxe Twin Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/family.jpg" width="100%"height="600px" alt="레지던스"></div>
                    <div class="sw_txt">Family Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/bathroom.jpg" width="100%"height="600px" alt="레지던스"></div>
                    <div class="sw_txt">Bathroom</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/outside2.jpg" width="100%" height="600px"alt="레지던스"></div>
                    <div class="sw_txt">로비</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/kitchen.jpg" width="100%"height="600px" alt="레지던스"></div>
                    <div class="sw_txt">부엌</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel3/machine.jpg" width="100%" height="600px"alt="레지던스"></div>
                    <div class="sw_txt">가전제품</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel3/standard_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/standard_double1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/bathroom.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="Residence"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel3/standard_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/standard_twin1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel3/deluxe_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/deluxe_twin1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel3/family.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/family1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel3/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div>
<img src="daejeonhotel3/outside1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>대전의 비즈니스, 레스토랑, 쇼핑 지역에서 좋은 위치에 있는 본 숙소(Residence Hotel Line)는 바쁜 일상으로부터 꿀맛 같은 휴식을 취할 수 있는 최적의 장소입니다.</p>
<p>본 숙소는 도심에서 거리에 있으며 중요한 도심 편의 시설에 접근하기 편리합니다.</p>
<p>본 숙소는 도시의 필수 관광 명소에 손쉽게 접근할 수 있는 편리한 위치를 자랑합니다.</p>
<br/>
<p>본 숙소(Residence Hotel Line)의 시설과 서비스는 투숙객에게 즐거운 숙박 경험을 선사합니다.</p> 
<p>본 숙소에서 Wi-Fi (무료/전 객실), 24시간 룸서비스, 24시간 경비 서비스, 편의점, 우편 서비스등을 포함해 다양한 서비스를 이용할 수 있습니다.</p>
</div>
</div>
</div>
<br/><hr/>
