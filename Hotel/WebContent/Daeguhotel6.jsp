...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel6_out4.jpg"width="100%" alt="고호스탤"></div>
                    <div class="sw_txt">고호스탤</div>
                </a>
            </div>
         <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel6_in1.jpg" width="100%" alt="고호스탤"></div>
                    <div class="sw_txt">고호스탤</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel6_in2.jpg" width="100%" alt="고호스탤"></div>
                    <div class="sw_txt">고호스탤</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel6_in3.jpg" width="100%" alt="고호스탤"></div>
                    <div class="sw_txt">고호스탤</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel6_in6.jpg" width="100%" alt="고호스탤"></div>
                    <div class="sw_txt">고호스탤</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel6_in4.jpg" width="100%" alt="고호스탤"></div>
                    <div class="sw_txt">고호스탤</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel6_in1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel6_in2.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel6_in1.jpg" width="300px" height="300px"/>
    </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="고호스탤"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel6_in5.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel6_in7.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel6_in2.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel6_in3.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel6_in7.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div>
<img src="daegu/daegu_hotel6_out2.jpg" style="margin-left:70px;width:90%;height:500px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
이 호스텔은 피레노폴리스에 자리해 있으며 무료 와이파이(Wi-Fi)를 제공합니다. 뿐만 아니라 테라스, 24시간 리셉션, 실외 풀도 완비되어 있습니다. 

이 호스텔의 고객님들은 이곳에 조성된 정원에서 즐거운 시간을 보내실 수 있습니다. 

이 호스텔에는 6개의 객실이 갖춰져 있으며 한정된 예산으로 여행하시는 분들에게 추천하는 숙소입니다. 그 밖에 객실에는 공동 욕실도 딸려 있습니다. 

이 호스텔은 뮤지엄 오브 더 카발랴다스, 시네 피레네우스, 패밀리 폼페우 뮤지엄에서 도보 거리에 있습니다.
</p>
</div>
</div>
</div>
