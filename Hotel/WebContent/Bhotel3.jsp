...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i1.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i2.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i3.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i4.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i5.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i6.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i7.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B3i8.jpg" width="100%" alt="켄트 호텔 광안리"></div>
                    <div class="sw_txt">켄트 호텔 광안리</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="켄트 호텔 광안리"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/B3e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
<strong>부산 광안리의 새로운 랜드마크 - 마린 부티크 콘셉트 ‘켄트호텔’</strong><br>
과거와 미래가 공존하고, 산과 바다의 아름다운 풍경을 동시에 즐길 수 있으며, 다양한 먹거리로 미식의 즐거움이 가득한 부산은 여행을 하기에 가장 매력적인 도시 중 하나입니다.<br> 
눈부시게 빛나는 태양, 시원하게 펼쳐진 광안리 바다와 반짝이는 광안대교 풍경을 한눈에 감상할 수 있으며, 새롭고 극적인 경험들과 함께 진정한 힐링이 가능한 ‘켄트호텔’은 2016년 5월 새롭게 오픈 하였습니다.<br>
 켄트호텔은 젊고 트렌디한 라이프 스타일 제안은 물론 상상 그 이상의 감동을 담은 부산 광안리의 새로운 랜드마크가 될 수 있도록 최고의 시설에 최고의 품격을 더하여 여러분을 초대합니다.
 </p>
</div>
</div>
</div>
