...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i1.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i2.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i3.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i4.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i5.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i6.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i7.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/J2i8.jpg" width="100%" alt="베스트웨스턴 제주"></div>
                    <div class="sw_txt">베스트웨스턴 제주</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="베스트웨스턴 제주"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/J2e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
세계 최대 체인브랜드인 베스트웨스턴을 최고의 휴양지 제주도에서 만나보세요
</p>
</div>
</div>
</div>
