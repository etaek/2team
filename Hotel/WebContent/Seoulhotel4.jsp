...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/standard_double.jpg" width="100%" height="600px"alt="리베라"></div>
                    <div class="sw_txt">Standard Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/standard_twin.jpg" width="100%"height="600px" alt="리베라"></div>
                    <div class="sw_txt">Standard Twin room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/deluxe_double.jpg" width="100%"height="600px" alt="리베라"></div>
                    <div class="sw_txt">Deluxe Double room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/deluxe_twin.jpg" width="100%"height="600px" alt="리베라"></div>
                    <div class="sw_txt">Deluxe Twin room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/robbi.jpg" width="100%"height="600px" alt="리베라"></div>
                    <div class="sw_txt">로비</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/restaurant.jpg" width="100%" height="600px"alt="리베라"></div>
                    <div class="sw_txt">Restaurant</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/golf.jpg" width="100%"height="600px" alt="리베라"></div>
                    <div class="sw_txt">Golf Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="seoulhotel4/swimpool.jpg" width="100%" height="600px"alt="리베라"></div>
                    <div class="sw_txt">Swimming Pool</div>
                </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel4/standard_double.jpg" width="300px" height="300px" />
    </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="Libera"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel4/standard_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel3/bathroom.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel4/deluxe_double.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel4/deluxe_double1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel4/deluxe_twin.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel4/deluxe_twin1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="seoulhotel1/bathroom3.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="seoulhotel4/sweet.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="seoulhotel4/sweet1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
...
<p>전망:시티뷰</p>
<p>샤워실 및 욕조</p><p>무료와이파이</p>
<p id="more">401호,402호</p>
</div>
<br/>
</div>
<br/><hr/>
<div>
<img src="seoulhotel4/outside.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>리베라 호텔은 인천 공항으로 부터 육십이킬로 떨어져 있으며 관광지나 비지니스 관련된 업무를 보시는 분들께는 쉽게 이동할 수 있는 서울의 강남에 위치에 있습니다. </p>
<p>또한 올림픽 경기장이나 컨벤션 전시장과도 가깝습니다.</p><p> 중식, 서양식, 인터내셔널 음식을 고루 선보이는 호텔내의 레스토랑에서 손쉽게 식사를 해결할 수 있고 식사후에는 칵테일바에서 음료를 즐기실 수 있습니다.</p>
<br/>
<p> 전시장이나 다른 레져 시설이 근처에 가깝게 있기 때문에 비지니스차 방문하시는 분들이나 일반관광객 모두에게 리베라 호텔은 이상적인 장소일 것입니다.</p> 
<p>웰빙을 우선으로 삼으시는 분들을 위해 휘트니스 센터가 23시까지 운영 되고 있고 여유가 있으시다면 수영장 근처의 라운지에서 음료를 마시며 시간을 보내시거나 마사지센터에서 마사지를 받아 보셔도 좋습니다. </p>
</div>
</div>
</div>
<br/><hr/>
