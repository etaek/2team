...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i1.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
			<div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i2.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i3.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i4.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i5.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i6.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i7.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="<%=request.getContextPath()%>/image/B4i8.jpg" width="100%" alt="파라다이스호텔"></div>
                    <div class="sw_txt">파라다이스호텔</div>
                </a>
            </div>
        </div>
...
<div class="input-group mb-3" style="width:271px;">
  ...
  <input type="text" class="form-control" value="파라다이스 호텔 부산"aria-label="Text input with checkbox" name="name">
</div>
...
<br/><hr/>
<div>
<img src="image/B4e1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
...
<h3>하늘과 바다가 맞닿은 곳,</h3>
<p>부산 해운대에 위치한 파라다이스호텔 부산은 파라다이스 그룹 산하계열의 총 532실의 특 1급 (5성) 호텔로 <br>
1981년 개업한 이래 부단한 노력을 경주한 결과 한국을 대표하는 국내 브랜드 호텔로 사랑받고 있습니다.<br>
항상 고객을 위해 과감한 시설 투자를 아끼지 않는 파라다이스 호텔 부산은 2007년 서비스에 디자인 경영을 도입하여 눈에 보이지 않는 서비스 상품에 디자인적 콘텐츠를 더하는 등 
항상 새로운 트렌드를 추구하고 있습니다.
</p>
</div>
</div>
</div>
