...
<title>Boutique Hotel Instar</title>
</head>
...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel4_out3.jpg"width="100%" alt="호텔 인스타"></div>
                    <div class="sw_txt">호텔 인스타</div>
                </a>
            </div>
         <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel4_in1.jpg" width="100%" alt="호텔 인스타"></div>
                    <div class="sw_txt">호텔 인스타</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel4_in2.jpg" width="100%" alt="호텔 인스타"></div>
                    <div class="sw_txt">호텔 인스타</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel4_in3.jpg" width="100%" alt="호텔 인스타"></div>
                    <div class="sw_txt">호텔 인스타</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel4_in5.jpg" width="100%" alt="호텔 인스타"></div>
                    <div class="sw_txt">호텔 인스타</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daegu/daegu_hotel4_in8.jpg" width="100%" alt="호텔 인스타"></div>
                    <div class="sw_txt">호텔 인스타</div>
                   </a>
            </div>
        </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel4_in1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel4_in2.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel4_in1.jpg" width="300px" height="300px"/>
    </div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="호텔 인스타"aria-label="Text input with checkbox" name="name">
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left;">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel4_in5.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel4_in6.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel4_in7.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daegu/daegu_hotel4_in8.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daegu/daegu_hotel4_in7.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="daegu/daegu_hotel4_in3.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
<div class="right">
...
<br/><hr/>
<div>
<img src="daegu/daegu_hotel4_out2.jpg" style="margin-left:70px;width:90%;height:500px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>
2016년도에 오픈한 호텔 인스타의 객실은 대구 호텔을 찾는 여행자들에게 최고의 선택입니다.
호텔에서 대구 국제공항이 단, 6km 정도 거리에 있고, Dongdaegu Station이 단, 8km 정도 거리에 있어 교통이 매우 편리합니다.
여가시간에는 다양한 호텔 시설을 이용하실 수 있습니다. 호텔의 주차 공간을 이용할 수 있습니다.
</p>
</div>
</div>
</div>
