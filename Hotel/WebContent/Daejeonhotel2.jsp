...
<div class="swiper-container">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/deluxe double room.jpg" width="100%" height="600px"alt="부티크"></div>
                    <div class="sw_txt">Deluxe Double Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/Superior Double Room.jpg" width="100%"height="600px" alt="부티크"></div>
                    <div class="sw_txt">Superior Double Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/Superior Twin Room.jpg"width="100%"height="600px" alt="부티크"></div>
                    <div class="sw_txt">Superior Twin Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/Premium Room.jpg" width="100%"height="600px" alt="부티크"></div>
                    <div class="sw_txt">Premium Room</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/bathroom.jpg" width="100%"height="600px" alt="부티크"></div>
                    <div class="sw_txt">Bathroom</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/outside2.jpg" width="100%" height="600px"alt="부티크"></div>
                    <div class="sw_txt">로비</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/outside3.jpg" width="100%"height="600px" alt="부티크"></div>
                    <div class="sw_txt">Restaurant</div>
                </a>
            </div>
            <div class="swiper-slide">
                <a href="">
                    <div class="sw_img"><img src="daejeonhotel2/outside5.jpg" width="100%" height="600px"alt="부티크"></div>
                    <div class="sw_txt">Bar</div>
                </a>
            </div>
        </div>
...
<div id="standard"></div>
<div id="deluxe"style="border:1px solid white;"></div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel2/deluxe double room.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/deluxe double room1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/bathroom.jpg" width="300px" height="300px"/>
    </div>
  </div>
</div>
...
<p id="queen">201호,202호,203호,204호</p>
</div>
...
<div class="input-group mb-3" style="width:100%;">
  ...
  <input type="text" class="form-control" value="buttique"aria-label="Text input with checkbox" name="name">
</div>
...
<div class="input-group input-group-sm mb-3" style="width:70%;margin-top:20px;float:left;">
  ...
  <select class="custom-select mb-3" name="room">
      	<option name="room">Deluxe Double</option>
      	<option name="room">Superior Double</option>
      	<option name="room">Superior Twin</option>
      	<option name="room">Premium</option>
   		 </select>
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel2/Superior Double Room2.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/Superior Double Room1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/bathroom1.jpg" width="300px" height="300px"/>
    </div>
    </div>
  </div>
</div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel2/Superior Twin Room.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/Superior Twin Room1.jpg" width="300px" height="300px"/>
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/bathroom1.jpg" width="300px" height="300px"/>
    </div>
...
<div  class="carousel slide" data-ride="carousel" style="width:300px;padding-top:30px;margin-left:150px;float:left">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="daejeonhotel2/Premium Room.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/Premium Room1.jpg" width="300px" height="300px" />
    </div>
    <div class="carousel-item">
      <img src="daejeonhotel2/bathroom1.jpg" width="300px" height="300px"/>
    </div>
...
<br/><hr/>
<div>
<img src="daejeonhotel2/outside1.jpg" style="margin-left:70px;width:90%;height:300px;" /><br/>
<div >
<div class="target1"><h4 style="font-size:18pt"><b>둘러보기</b></h4></div>
<div class="target2">

<p>대전의 쇼핑, 비즈니스, 레스토랑 지역에서 좋은 위치에 있는 본 숙소(부티크 호텔 락희)는 바쁜 일상으로부터 꿀맛 같은 휴식을 취할 수 있는 최적의 장소입니다. </p>
<p>도시의 재미가 가득한 곳에서 거리에 있는 이 2.5성급 숙소는 좋은 위치와 도시의 많은 명소들로의 접근성을 자랑합니다. </p>
<p>투숙객들은 비오템 타임월드, 마스터 골프샵, 대전 둔산 기독교백화점 등과 같은 도시 최고의 명소 관광을 즐길 수 있습니다.</p>
<br/>
<p>본 숙소(부티크 호텔 락희)에는 다양한 시설이 있어 대전에서의 여행 시간을 풍요롭게 해줍니다.</p> 
<p>투숙객 편의와 편안함을 위해 숙소에서 Wi-Fi (무료/전 객실), 24시간 경비 서비스, 편의점, 일일 청소 서비스, 택시 서비스 등을 제공합니다.</p>
</div>
</div>
</div>
<br/><hr/>
